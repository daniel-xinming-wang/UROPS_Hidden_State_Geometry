...
# %%
with_image_path = "Data/Representation/MathVision/Qwen3-VL-4B-Thinking"
without_image_path = "Data/Representation/MathVision-no-image/Qwen3-VL-4B-Thinking-no-image"

# %%
results = analyze_rank(with_image_path, without_image_path)

# %%
with_image_path_2b = "Data/Representation/MathVision/Qwen3-VL-2B-Thinking"
without_image_path_2b = "Data/Representation/MathVision-no-image/Qwen3-VL-2B-Thinking-no-image"
...
# %%
with_image_path_8b = "Data/Representation/MathVision/Qwen3-VL-8B-Thinking"
without_image_path_8b = "Data/Representation/MathVision-no-image/Qwen3-VL-8B-Thinking-no-image"
...
# %%
with_image_path_glm = "Data/Representation/MathVision/GLM-4.1V-9B-Thinking"
without_image_path_glm = "Data/Representation/MathVision-no-image/GLM-4.1V-9B-Thinking-no-image"
...
# %%
results = pd.read_csv("Results/results_4b_mathv.csv")

# %%
plot_rank_results(results, title="(Qwen3-VL-4B-Thinking)")

# %%
results_2b = pd.read_csv("Results/results_2b_mathv.csv")

# %%
plot_rank_results(results_2b, title="(Qwen3-VL-2B-Thinking)")

# %%
results_8b = pd.read_csv("Results/results_8b_mathv.csv")

# %%
plot_rank_results(results_8b, title="(Qwen3-VL-8B-Thinking)")

# %%
results_glm = pd.read_csv("Results/results_glm_mathv.csv")
...
# %%
results_noimg_pc = pd.read_csv("Results/mathv_results_no_img_pc_df_4b.csv").values.tolist()
...
# %%
results_overlap_glm = pd.read_csv("Results/results_overlap_glm_40.csv").iloc[:, 0:41].values.tolist()
...
# %%
results_overlap_8b = pd.read_csv("Results/results_overlap_8b_40.csv").values.tolist()
...
# %%
results_overlap_2b = pd.read_csv("Results/results_overlap_2b.csv").values.tolist()
...
# %%
results_overlap_4b = pd.read_csv("Results/results_overlap_4b_25.csv").values.tolist()
